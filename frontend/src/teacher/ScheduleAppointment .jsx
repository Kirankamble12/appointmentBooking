...
export const ScheduleAppointment = () => {
  ...
  useEffect(() => {
    // ✅ Get Teacher Details from Local Storage
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:4000/api/teacher/schedule-appointment/${teacher.email}`, {
        method: "POST",
      ...
      if (data.success) {
        ...
        setFormData({ studentEmail: "", date: "", time: "" }); // ✅ Clear Form
      } else {
  ...
  return (
    <div className="max-w-lg mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
      ...
      <h2 className="text-3xl font-bold text-center text-violet-700">Schedule Appointment</h2>
